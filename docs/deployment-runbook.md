...
1. `bash infra/scripts/deploy-ubuntu.sh --public-domain plurihub.sylicaai.com --base-domain sylicaai.com --preview-base-domain preview.sylicaai.com --certbot-email ops@sylicaai.com --with-provision --run-certbot`
