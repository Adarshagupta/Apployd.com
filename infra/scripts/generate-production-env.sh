...
Runtime secrets are sourced from env vars when present:
  ...
  DODO_PAYMENTS_PRODUCT_ID_DEV
  DODO_PAYMENTS_PRODUCT_ID_PRO
  DODO_PAYMENTS_PRODUCT_ID_MAX
  SMTP_HOST
  SMTP_PORT
  SMTP_SECURE
  SMTP_USER
...
DODO_PAYMENTS_API_KEY_VALUE="${DODO_PAYMENTS_API_KEY:-dodo_test_replace}"
DODO_PAYMENTS_WEBHOOK_SECRET_VALUE="${DODO_PAYMENTS_WEBHOOK_SECRET:-whsec_replace}"
DODO_PAYMENTS_ENVIRONMENT_VALUE="${DODO_PAYMENTS_ENVIRONMENT:-test}"
DODO_PAYMENTS_PRODUCT_ID_DEV_VALUE="${DODO_PAYMENTS_PRODUCT_ID_DEV:-prod_dev_replace}"
DODO_PAYMENTS_PRODUCT_ID_PRO_VALUE="${DODO_PAYMENTS_PRODUCT_ID_PRO:-prod_pro_replace}"
DODO_PAYMENTS_PRODUCT_ID_MAX_VALUE="${DODO_PAYMENTS_PRODUCT_ID_MAX:-prod_max_replace}"
...
REDIS_URL=$REDIS_URL
DODO_PAYMENTS_API_KEY=$DODO_PAYMENTS_API_KEY_VALUE
DODO_PAYMENTS_WEBHOOK_SECRET=$DODO_PAYMENTS_WEBHOOK_SECRET_VALUE
DODO_PAYMENTS_ENVIRONMENT=$DODO_PAYMENTS_ENVIRONMENT_VALUE
DODO_PAYMENTS_PRODUCT_ID_DEV=$DODO_PAYMENTS_PRODUCT_ID_DEV_VALUE
DODO_PAYMENTS_PRODUCT_ID_PRO=$DODO_PAYMENTS_PRODUCT_ID_PRO_VALUE
DODO_PAYMENTS_PRODUCT_ID_MAX=$DODO_PAYMENTS_PRODUCT_ID_MAX_VALUE
...
ALLOW_RISKY_DEPLOYMENT_COMMANDS=false
...
ENGINE_HEALTHCHECK_DELAY_MS=1000
ENGINE_LOCAL_MODE=false
ENGINE_CONTAINER_READ_ONLY=true
ENGINE_SECURITY_MODE=strict
ENGINE_SECURITY_AUTO_BLOCK=true
ENGINE_SECURITY_ALLOW_PRIVATE_EGRESS=true
ENGINE_EGRESS_ALLOWED_TCP_PORTS=80,443
ENGINE_EGRESS_ALLOWED_UDP_PORTS=53,123
ENGINE_EGRESS_BLOCKED_TCP_PORTS=21,22,23,25,69,445,1433,3306,3389,5432,6379,8080,11211
ENGINE_EGRESS_BLOCKED_UDP_PORTS=19,161
ENGINE_SECURITY_MAX_DISTINCT_REMOTE_PORTS=8
ENGINE_SECURITY_MAX_DISTINCT_REMOTE_HOSTS=80
ENGINE_SECURITY_MAX_SYN_SENT_CONNECTIONS=30
EOF
