...
Runtime secrets are sourced from env vars when present:
  ...
  DODO_PAYMENTS_DEFAULT_COUNTRY
  DODO_PAYMENTS_PRODUCT_ID_DEV
  DODO_PAYMENTS_PRODUCT_ID_PRO
  DODO_PAYMENTS_PRODUCT_ID_MAX
  DODO_PAYMENTS_PRODUCT_ID_AGENT_STARTER
  DODO_PAYMENTS_PRODUCT_ID_AGENT_GROWTH
  DODO_PAYMENTS_PRODUCT_ID_AGENT_SCALE
  DODO_PAYMENTS_ADDON_ID_DATABASE_STARTER
  DODO_PAYMENTS_ADDON_ID_DATABASE_GROWTH
  DODO_PAYMENTS_ADDON_ID_DATABASE_SCALE
  SMTP_HOST
  SMTP_PORT
  SMTP_SECURE
  SMTP_USER
...
DODO_PAYMENTS_DEFAULT_COUNTRY_VALUE="${DODO_PAYMENTS_DEFAULT_COUNTRY:-US}"
...
DODO_PAYMENTS_PRODUCT_ID_AGENT_STARTER_VALUE="${DODO_PAYMENTS_PRODUCT_ID_AGENT_STARTER:-prod_agent_starter_replace}"
DODO_PAYMENTS_PRODUCT_ID_AGENT_GROWTH_VALUE="${DODO_PAYMENTS_PRODUCT_ID_AGENT_GROWTH:-prod_agent_growth_replace}"
DODO_PAYMENTS_PRODUCT_ID_AGENT_SCALE_VALUE="${DODO_PAYMENTS_PRODUCT_ID_AGENT_SCALE:-prod_agent_scale_replace}"
DODO_PAYMENTS_ADDON_ID_DATABASE_STARTER_VALUE="${DODO_PAYMENTS_ADDON_ID_DATABASE_STARTER:-adn_starter_replace}"
DODO_PAYMENTS_ADDON_ID_DATABASE_GROWTH_VALUE="${DODO_PAYMENTS_ADDON_ID_DATABASE_GROWTH:-adn_growth_replace}"
DODO_PAYMENTS_ADDON_ID_DATABASE_SCALE_VALUE="${DODO_PAYMENTS_ADDON_ID_DATABASE_SCALE:-adn_scale_replace}"
...
DODO_PAYMENTS_DEFAULT_COUNTRY=$DODO_PAYMENTS_DEFAULT_COUNTRY_VALUE
...
DODO_PAYMENTS_PRODUCT_ID_AGENT_STARTER=$DODO_PAYMENTS_PRODUCT_ID_AGENT_STARTER_VALUE
DODO_PAYMENTS_PRODUCT_ID_AGENT_GROWTH=$DODO_PAYMENTS_PRODUCT_ID_AGENT_GROWTH_VALUE
DODO_PAYMENTS_PRODUCT_ID_AGENT_SCALE=$DODO_PAYMENTS_PRODUCT_ID_AGENT_SCALE_VALUE
DODO_PAYMENTS_ADDON_ID_DATABASE_STARTER=$DODO_PAYMENTS_ADDON_ID_DATABASE_STARTER_VALUE
DODO_PAYMENTS_ADDON_ID_DATABASE_GROWTH=$DODO_PAYMENTS_ADDON_ID_DATABASE_GROWTH_VALUE
DODO_PAYMENTS_ADDON_ID_DATABASE_SCALE=$DODO_PAYMENTS_ADDON_ID_DATABASE_SCALE_VALUE
